...
| ------ | ---- | --- | ------ | --- | ---- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Falcon | Host | 1   | OMV    | 4   | 16gb | 512gb | Samba<br>NFS<br>Pihole<br>Tailscale<br>Authentik<br>Cloudflared<br>Traefik<br>Grafana<br>Loki<br>Prometheus<br>Statds Explorer<br>Whats Up Docker<br>Open WebUI<br>Zigbee2mqtt<br>Mqtt<br>Home Assistant<br>Syncthing<br>Homepage<br>It Tools<br>Stirling PDF<br>RomM<br>Next Explorer<br>Immich<br>Jellyfin<br>Transmission |
