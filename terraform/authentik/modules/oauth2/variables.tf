...
variable "grafana_property_mapping_id" {
  description = "Grafana property mapping ID"
  type        = string
}

variable "romm_property_mapping_id" {
  description = "Romm property mapping ID"
  type        = string
}

variable "nextexplorer_property_mapping_id" {
  description = "nextExplorer property mapping ID"
  type        = string
}
